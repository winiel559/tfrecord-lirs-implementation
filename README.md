...
* The [example](https://github.com/winiel559/tfrecord-lirs-implementation/blob/main/mnist%20to%20sparse%20with%20padding%20next-fit%20class.ipynb) shows how to take a raw data and contruct a TFRecord file. Before using it, you need to download [the MNIST dataset](http://yann.lecun.com/exdb/mnist/).
